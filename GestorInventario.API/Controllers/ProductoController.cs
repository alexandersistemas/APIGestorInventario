...
namespace GestorInventario.API.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        [HttpPut]
        [Route("Editar")]
        public async Task<IActionResult> Editar([FromBody] ProductoDTO paciente)
        {
            ...
            {
                rsp.status = true;
                rsp.value = await _productoServicio.Editar(paciente);
        ...
        public async Task<IActionResult> Obtener(int id)
        {
            ...
            {
                rsp.status = true;
                rsp.value = await _productoServicio.Obtener(id);
